...
if( client_obj:hasAccountManager() ) then
  ...
  if(orderVolumeRisk ~= nil) then
    ...
    table.insert (depositItem, {'options_mm', easygetter.EvenAmountToDouble(orderVolumeRisk:getTotalOptionM2M())})
      ...
      for _,orderLeg in pairs(orderlegs) do
        ...
        for _,op in pairs( order:getOrderOperations() ) do
          if op:getTransactionType() == "Match" then
            cache.MatchedOrder[order:getOrderId()] = "Match"
            print("position : " .. order:getOrderId() .. " status : Matched")
  ...
  for _,position in pairs ( position_list ) do
    ...
    local posE=fo.PositionEvaluation{ position=position }
    print("---------------  start --------------------------------------")
    print("=posE:getAvailableQuantity()=" .. posE:getAvailableQuantity())
    print("=posE:getAvgePrice()=" .. posE:getAvgePrice())
    print("=posE:getAvgePriceNet()=" .. posE:getAvgePriceNet())
    print("=posE:getBreakEvenPriceNet()=" .. posE:getBreakEvenPriceNet())
    print("=posE:getBreakEvenValueNet()=" .. posE:getBreakEvenValueNet())
    --print("=posE:getContractEvaluation()=" .. posE:getContractEvaluation())
    print("=posE:getExposedValue()=" .. posE:getExposedValue())
    --print("=posE:getFeeSum()=" .. posE:getFeeSum())
    --print("=posE:getHistPlTime()=" .. posE:getHistPlTime())
    --print("=posE:getIntrinsicValue()=" .. easygetter.EvenAmountToDouble(posE:getIntrinsicValue()))
    --print("=posE:getIsLong()=" .. posE:getIsLong())
    print("=posE:getLiqMarketPrice()=" .. posE:getLiqMarketPrice())
    print("=posE:getLiqMarketValue()=" .. posE:getLiqMarketValue())
    print("=posE:getLiqMarketValueNet()=" .. posE:getLiqMarketValueNet())
    print("=posE:getLiqQuote()=" .. posE:getLiqQuote())
    --print("=posE:getLiqQuoteIsSynthetic()=" .. posE:getLiqQuoteIsSynthetic())
    print("=posE:getLiqSynthDeviation()=" .. posE:getLiqSynthDeviation())
    print("=posE:getPosBookValue()=" .. posE:getPosBookValue())
    print("=posE:getPosBookValueNet()=" .. posE:getPosBookValueNet())
    --print("=posE:getPosition()=" .. posE:getPosition())
    --print("=posE:getPresentationCurrency()=" .. posE:getPresentationCurrency())
    print("=posE:getQuantity()=" .. posE:getQuantity())
    print("=posE:getRplGrossMZ()=" .. posE:getRplGrossMZ())
    --print("=posE:getTheoPrice()=" .. posE:getTheoPrice())
    print("=posE:getTplGrossMZ()=" .. posE:getTplGrossMZ())
    --print("=posE:getTradingCurrency()=" .. posE:getTradingCurrency())
    --print("=posE:getUnitMarketValue()=" .. posE:getUnitMarketValue())
    print("=posE:getUplGrossMZ()=" .. posE:getUplGrossMZ())
    print("getOrdersBuy in getAccPositions : " .. position:getOrdersBuy())
    print("getOrdersSell in getAccPositions : " .. position:getOrdersSell())
    ...
    local mark_average=easygetter.EvenAmountToDouble(data.endAveragePriceNet)
    local act_cost=easygetter.EvenAmountToDouble(data.endPosBookValue)
    local Realized_PL=easygetter.EvenAmountToDouble(data.startToEndRPL)
    local Unrealized_PL=easygetter.EvenAmountToDouble(data.startToEndRPL)
    table.insert (orderItem, {'side', position_short_long})
    print("position_short_long in getAccPositions : " .. position_short_long)
    print("act_cost in getAccPositions : " .. act_cost)
    print("data.endAveragePriceNet : " .. mark_average)
    print("Realized_PL : " .. Realized_PL)
    print("Unrealized_PL : " .. Unrealized_PL)
    ...
    if (position_short_long == "Long") then
      ...
      table.insert (orderItem, {'long_unreal', easygetter.EvenAmountToDouble(data.startToEndRPL)})
      table.insert (orderItem, {'long_act_cost',act_cost})
      ...
      table.insert (orderItem, {'short_unreal', easygetter.EvenAmountToDouble(data.startToEndRPL)})
      table.insert (orderItem, {'short_act_cost',act_cost})
